...
function About() {
  return (
    <div className="sm:mx-10 sm: p-5 space-y-5 pt-40 text-center min-h-screen">
      <h1 className="text-3xl font-bold text-gray-800 text-center mb-4 underline">
        About Us
      </h1>
      <p className="sm:text-xl text-lg text-gray-700 leading-relaxed">
        Welcome to
        <span className="font-semibold text-gray-800">FASHION.FINDS</span>! My
      ...
      <p className="sm:text-xl text-lg text-gray-700 leading-relaxed">
        As the founder of
        <span className="font-semibold text-gray-800">FASHION.FINDS</span>,
        I&apos;m dedicated to providing a shopping experience that goes beyond
        your expectations. From our product selection to customer service,
        everything is designed with you in mind. Thank you for visiting, and I
        hope you find something that resonates with your unique style.
      </p>
      <p className="sm:text-2xl text-xl text-gray-700 leading-relaxed text-center">
        Happy shopping at
        <span className="font-semibold text-gray-800">FASHION.FINDS</span>!
      </p>
    </div>
